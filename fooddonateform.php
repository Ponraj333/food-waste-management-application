...
if(isset($_POST['submit'])) {
    ...
    $prepared_time = mysqli_real_escape_string($connection, $_POST['prepared_time']); // New field

    $query = "INSERT INTO food_donations(email, food, type, category, phoneno, location, address, name, quantity, prepared_time) 
              VALUES('$emailid', '$foodname', '$meal', '$category', '$phoneno', '$district', '$address', '$name', '$quantity', '$prepared_time')";
    ...
    <div class="container">
        <div class="regformf">
            <form action="" method="post">
                ...
                <!-- Prepared Time Input -->
                <div class="input">
                    <label for="prepared_time">Prepared Time:</label>
                    <input type="datetime-local" id="prepared_time" name="prepared_time" required />
                </div>
